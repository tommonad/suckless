...
static const Rule rules[] = {
	...
	*/
	...
	{ "Tixati",   NULL,       NULL,       	    1 << 8,       0,           0,         0,        -1 },
	{ "vym",   NULL,       NULL,       	    1 << 6,       0,           0,         0,        -1 },
...
static const Key keys[] = {
	...
	/* { MODKEY|ShiftMask,		XK_Escape,	spawn,	SHCMD("/home/tom/scripts/setup_monitors.sh") }, */
	...
	/* { MODKEY,			XK_Insert,	spawn,		SHCMD("xdotool type $(grep -v '^#' ~/.local/share/Bookmarks/snippets | dmenu -i -l 50 | cut -d' ' -f1)") }, */
